...
namespace Maliev.CareerService.Data.Migrations
{
    ...
    [Migration("20260110130516_AddValidityMonthsToTrainingProgram")]
    partial class AddValidityMonthsToTrainingProgram
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maliev.CareerService.Data.Models.MandatoryTrainingRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mandatory_training_requirements");
                    ...
                    b.ToTable("mandatory_training_requirements", null, t =>
                        {
                            t.HasCheckConstraint("chk_mandatory_training_requirements_deadline_range", "completion_deadline_days BETWEEN 1 AND 365");

                            t.HasCheckConstraint("chk_mandatory_training_requirements_recertification_range", "recertification_months IS NULL OR (recertification_months BETWEEN 1 AND 120)");
                        });
                });

            modelBuilder.Entity("Maliev.CareerService.Data.Models.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("skills", null, t =>
                        {
                            t.HasCheckConstraint("chk_skills_proficiency_level_range", "proficiency_level BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("Maliev.CareerService.Data.Models.TrainingRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("training_records", null, t =>
                        {
                            t.HasCheckConstraint("chk_training_records_completion_not_future", "completion_date <= NOW()");

                            t.HasCheckConstraint("chk_training_records_expiration_after_completion", "expiration_date IS NULL OR expiration_date > completion_date");

                            t.HasCheckConstraint("chk_training_records_score_range", "score IS NULL OR (score >= 0 AND score <= 100)");
                        });
                });
            ...
            modelBuilder.Entity("Maliev.CareerService.Data.Models.MandatoryTrainingRequirement", b =>
                {
                    b.HasOne("Maliev.CareerService.Data.Models.TrainingProgram", "TrainingProgram")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_mandatory_training_requirements__training_programs_training_p~");
            ...
            modelBuilder.Entity("Maliev.CareerService.Data.Models.TrainingRecord", b =>
                {
                    b.HasOne("Maliev.CareerService.Data.Models.TrainingProgram", "TrainingProgram")
                        ...
                        .HasForeignKey("TrainingProgramId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_training_records_training_programs_training_program_id");
